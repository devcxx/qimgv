...
void PenTool::initUI()
{
    ...
    btnPoint=new BaseButton(qCore->pngImagePath()+QStringLiteral("dots@2x.png"),tr("Point"),this);
    btnLine=new BaseButton(qCore->pngImagePath()+QStringLiteral("line@2x.png"),tr("Line"),this);
    btnDashLine=new BaseButton(qCore->pngImagePath()+QStringLiteral("dashline@2x.png"),tr("Dash Line"),this);
    btnCurve=new BaseButton(qCore->pngImagePath()+QStringLiteral("curve@2x.png"),tr("Curve"),this);
